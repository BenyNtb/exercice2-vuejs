        ...
        <div class="col-md-4">
          <div class="card card-shadow border-0 mb-4"
            ...
            <div class="card-body">
              ...
              <h2 class="text-white mt-0 monthly">{{price1}}</h2>
              ...
              <a class="btn btn-outline-success btn-md rounded-pill mb-3" href="#f1"><span>{{learn}}</span></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 middle-box">
          <div class="card card-shadow border-0 mb-4"
            ...
            <div class="card-body">
              ...
              <h2 class="text-white mt-0 monthly">{{price2}}</h2>
              <h2 class="text-white mt-0 yearly">{{priceyear2}}</h2>
              <div class="star-plan mt-3"><img
                  src="https://www.wrappixel.com/demos/ui-kit/wrapkit/assets/images/pricing/star.png" alt="wrapkit" />
              </div>
              <ul class="general-listing">
                <li class="py-3 d-block">
        ...
        <div class="col-md-4">
          <div class="card card-shadow border-0 mb-4"
            ...
            <div class="card-body">
              ...
              <h2 class="text-white mt-0 monthly">{{price3}}</h2>
...
<style>
  ...
  .deux {
    background-color: rgb(110, 43, 224)
  }
  .pricing5 .subtitle {
    color: #8d97ad;
    line-height: 24px;
